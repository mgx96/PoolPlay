  ...
  return (
    <div className="bg-red-400 rounded-2xl p-6 w-64 shadow-lg">
      <div className="flex flex-col items-center mb-6">
        <div className="bg-red-300/30 p-4 rounded-xl mb-4">
          <div className="w-16 h-16 border-4 border-red-200 rounded-lg relative">
            <div className="absolute -top-3 -left-3 w-16 h-16 border-4 border-red-100 rounded-lg"></div>
          </div>
        </div>
