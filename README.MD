...
PoolPlay is an experimental decentralized lottery protocol built on Arbitrum Layer 2. It introduces risk-adjusted prize pools with fixed participant sizes, using verifiable on-chain randomness to determine winners in a fully transparent and non-custodial manner.
...
- On-chain verifiable randomness (Chainlink VRF)
...
| Networks | Arbitrum One and Arbitrum Sepolia  |
...
```bash
git clone https://github.com/mgx96/poolplay.git
cd poolplay
```
